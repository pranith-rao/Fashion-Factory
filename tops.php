...
<body>
    <div class="page-content">
        <?php
        $stmt = $pdo->query("SELECT * FROM stock where item like '%top%' or item like '%kurti%' or product_name like '%top%' 
        or product_name like '%kurti%'"); //like checks whether the word top and kurti are in the columns item or 
