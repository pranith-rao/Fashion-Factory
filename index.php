...
<footer>
  <div class="main">
    ...
    <div class="mid">
      <h2>Address</h2>
      <ul>
        <li><i class="fas fa-map-marker-alt"></i><span class="text">SJEC,Mangalore</span></li>
        <div class="phone">
          <li><i class="fas fa-phone-alt"></i><span class="text">+91-123456789</span></li>
        </div>
        <li><i class="fas fa-envelope-square"></i><span class="text">abc@example.com</span></li>
      </ul>
    </div>
    <div class="right">
      <h2>Contact us</h2>
